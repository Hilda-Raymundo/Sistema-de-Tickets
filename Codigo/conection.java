...
public class conection extends OperacionesVentana{
    ...
    public ObservableList<Tabla> asignarDatosATabla(String sql, String parametro1, String parametro2, String parametro3, String parametro4, String parametro5, String parametro6) throws SQLException{
        ObservableList<Tabla> listado = FXCollections.observableArrayList();
        listado.clear();
        ...
        try (Connection conn = conectar();
            ...
            ResultSet rs = ps.executeQuery()) {
            while(rs.next()){   
                listado.add(new Tabla(rs.getString(parametro1), rs.getString(parametro2), rs.getString(parametro3), rs.getString(parametro4), rs.getString(parametro5), rs.getString(parametro6)));
            }
        } catch (Exception e) {
            // Si hay un error en la conexión
            JOptionPane.showMessageDialog(null, "ERRORES:" + e.getMessage());
